 ...
 * @returns
 */
function rawSend(sendRequest: SendRequestBody, apiHost: Host): Promise<Response> {
    return fetch(`${apiHost}/api/v1/send`, stringifyAndMakePOSTRequest(sendRequest))
}
