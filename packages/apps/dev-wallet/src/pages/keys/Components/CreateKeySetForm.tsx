...
export function CreateKeySetForm({
  ...
  useEffect(() => {
    setAsideTitle('Add keys to keyset');
  }, []);
  ...
  return (
    ...
    >
      <Stack flexDirection={'column'} gap={'xxxl'} flex={1}>
        <Stack flexDirection={'column'} gap={'lg'} flex={1}>
                        ...
                        <ComboboxItem key={key} textValue={key}>
                          <Stack gap={'sm'} justifyContent={'space-between'}>
                            <Stack gap={'sm'}>
                              ...
                              <Text color="inherit">{shorten(key, 12)}</Text>
                            </Stack>
                            <Stack gap={'sm'}>
          ...
          <Stack flexDirection={'column'} gap={'xl'}>
            ...
            <Stack flexDirection={'column'} gap={'sm'}>
              ...
              />
              <Text size="small">
                The predicate method defines how many keys are required for the
                transaction that uses this keyset.
              </Text>
            </Stack>
          </Stack>
        </Stack>
        <Stack
          ...
          overflow="auto"
        >
          <Heading variant="h5">These keys will be added to the keyset</Heading>
