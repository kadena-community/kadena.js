        ...
        children: [
          {
            children: [
              {
                children: [],
                root: '/docs/pact/reference/property-checking-system/what-do-properties-and-schema-invariants-look-like',
              ...
              {
                children: [],
                root: '/docs/pact/reference/property-checking-system/how-does-it-work',
              ...
              {
                children: [],
                root: '/docs/pact/reference/property-checking-system/how-do-you-use-it',
              ...
              {
                children: [],
                root: '/docs/pact/reference/property-checking-system/expressing-properties',
              ...
              {
                children: [],
                root: '/docs/pact/reference/property-checking-system/expressing-schema-invariants',
              ...
              {
                children: [],
                root: '/docs/pact/reference/property-checking-system/a-simple-balance-transfer-example',
            ...
            root: '/docs/pact/reference/property-checking-system',
            title: 'What is it?',
          ...
          },
          {
            children: [
              {
                children: [],
                root: '/docs/pact/reference/built-in-functions/database',
                title: 'Database',
                menu: 'Database',
                label: 'Database',
                order: 1,
              ...
              {
                children: [],
                root: '/docs/pact/reference/built-in-functions/time',
                title: 'Time',
                menu: 'Time',
                label: 'Time',
                order: 2,
              ...
              {
                children: [],
                root: '/docs/pact/reference/built-in-functions/operators',
                title: 'Operators',
                menu: 'Operators',
                label: 'Operators',
                order: 3,
              ...
              {
                children: [],
                root: '/docs/pact/reference/built-in-functions/keysets',
                title: 'Keysets',
                menu: 'Keysets',
                label: 'Keysets',
                order: 4,
              ...
              {
                children: [],
                root: '/docs/pact/reference/built-in-functions/capabilities',
                title: 'Capabilities',
                menu: 'Capabilities',
                label: 'Capabilities',
                order: 5,
              ...
              {
                children: [],
                root: '/docs/pact/reference/built-in-functions/spv',
                title: 'SPV',
                menu: 'SPV',
                label: 'SPV',
                order: 6,
              ...
              {
                children: [],
                root: '/docs/pact/reference/built-in-functions/commitments',
                title: 'Commitments',
                menu: 'Commitments',
                label: 'Commitments',
                order: 7,
              ...
              {
                children: [],
                root: '/docs/pact/reference/built-in-functions/guards',
                title: 'Guards',
                menu: 'Guards',
                label: 'Guards',
                order: 8,
              ...
              {
                children: [],
                root: '/docs/pact/reference/built-in-functions/zk',
                title: 'Zk',
                menu: 'Zk',
                label: 'Zk',
                order: 9,
              ...
              {
                children: [],
                root: '/docs/pact/reference/built-in-functions/repl-only-functions',
            ...
            root: '/docs/pact/reference/built-in-functions',
            title: 'General',
            menu: 'Built-in Functions',
            label: 'General',
            order: 0,
