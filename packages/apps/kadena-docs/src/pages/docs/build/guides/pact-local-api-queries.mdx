...
[Welcome to Pact](/learn-pact/beginner/welcome-to-pact) section to get started
with Pact learning the basics. For a more straightforward and technical
...
- [@emilypi](https://github.com/emilypi)'s
  ...
  bash script
- [@LindaOrtega](https://kadena-io.github.io/github.com/LindaOrtega)'s bash
  script
