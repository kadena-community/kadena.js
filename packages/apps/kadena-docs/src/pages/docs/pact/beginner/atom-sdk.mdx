...
[Mac](/learn-pact/beginner/atom-sdk#installing-pact-mac) and Linux to get it
...
continue to
[installing Pact language with Homebrew](/learn-pact/beginner/atom-sdk#installing-pact-with-homebrew).
