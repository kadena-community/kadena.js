...
- **Auth Module:**
  [Project: Rotatable Wallet](/learn-pact/beginner/rotatable-wallet)
- **Payments Module:**
  [Accounts and Transfers](/learn-pact/beginner/accounts-and-transfers) :::
...
[4.2 in Project Rotatable Wallet](/learn-pact/beginner/rotatable-wallet/#42-enforce-user).
...
[Testing Pact Code in the SDK](/learn-pact/beginner/test-in-the-sdk).
...
[Testing Pact Code in the SDK](/learn-pact/beginner/test-in-the-sdk/#run-repl-file).
