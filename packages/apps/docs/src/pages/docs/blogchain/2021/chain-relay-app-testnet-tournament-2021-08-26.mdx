...
[blog post](https://medium.com/kadena-io/getting-started-with-chainweb-relay-app-7e7a01fe79c8).
Join our **#chain-relay **channel on our
[Discord server](http://discord.io/kadena) to ask any questions about running
the relay app or the competition!
