...
![create-account](/assets/docs/account-exist.png)
...
the Kadena blockchain. Visit [learn pact](/learn-pact/intro) for developer
tutorials covering key concepts and real projects you can deploy yourself.
