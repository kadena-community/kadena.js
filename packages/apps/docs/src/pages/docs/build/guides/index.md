...
:::tip For convenience you can find this project in this
...
[#keysets-and-authorization](/docs/pact/reference/concepts#keysets-and-authorization)
...
[#define-keyset](/docs/pact/reference/functions/keysets#define-keyset)
...
- [#read-msg](/docs/pact/reference/functions#readmsg)
- [#read-keyset](/docs/pact/reference/functions/keysets#readkeyset)
- [#read-string](/docs/pact/reference/functions#readstring)
- [#read-integer](/docs/pact/reference/functions#readinteger)
- [#read-decimal](/docs/pact/reference/functions#readdecimal)
...
[#keyset-ref-guard](/docs/pact/reference/functions/guards#keysetrefguard)
...
executed on Chainweb. [#interfaces](/docs/pact/reference/concepts#interfaces)
...
[#module-references](/docs/pact/reference/concepts#module-references)
...
[#module](/docs/pact/reference/syntax#module)
...
[#keysets-vs-governance-functions](/docs/pact/reference/concepts#keysets-vs-governance-functions)
...
[#docs-and-metadata](/docs/pact/reference/syntax#docs-and-metadata)
...
[#what-do-properties-and-schema-invariants-look-like](/docs/pact/reference/property-checking#what-do-properties-and-schema-invariants-look-like)

Properties (but not invariants) can be defined at the top level of the module so
they can be reused in multiple functions.
[#defining-and-reusing-properties](/docs/pact/reference/property-checking#defining-and-reusing-properties)
...
[#defconst](/docs/pact/reference/syntax#defconst)
...
a table with `deftable`. [#deftable](/docs/pact/reference/syntax#deftable)
...
[#property-and-invariant-functions](/docs/pact/reference/properties-and-invariants#property-and-invariant-functions)
...
(deftable) function. [#deftable](/docs/pact/reference/syntax#deftable)
...
[#create-table](/docs/pact/reference/functions/database#create-table)

Pact supplies several data-access functions for working with tables.
[#database](/docs/pact/reference/functions/database#database)
...
[#capabilities](/docs/pact/reference/concepts#capabilities)
...
[#with-capability](/docs/pact/reference/functions/capabilities#withcapability)
[#require-capability](/docs/pact/reference/functions/capabilities#requirecapability)
...
them here:
[#signatures-and-managed-capabilities](/docs/pact/reference/concepts#signatures-and-managed-capabilities)
...
`(column-delta)`.
[#column-delta](/docs/pact/reference/properties-and-invariants/database#columndelta)
...
(enforce). [#enforce](/docs/pact/reference/functions#enforce)
...
[#with-default-read](/docs/pact/reference/functions/database#withdefaultread)
...
[#let](/docs/pact/reference/syntax#let)
...
[#read](/docs/pact/reference/properties-and-invariants/database#read)
...
[#with-read](/docs/pact/reference/functions/database#withread)
...
you can use `(update)`.
[#update](/docs/pact/reference/functions/database#update)
