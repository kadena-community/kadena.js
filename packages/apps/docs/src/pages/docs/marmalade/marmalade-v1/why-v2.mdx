...
We've also introduced a **Policy Manager** to manage these policies more
efficiently. Instead of invoking functions directly from each policy as we used
to, we now call them from this central hub, making policy enforcement smoother
and more streamlined.

We've made the move from **On-chain manifest to Off-chain URI** to standardise
token data retrieval. We've also encouraged the use of IPFS for off-chain data
hosting for a more decentralized approach, which many of you advocated for.
...
covered - just incorporate `onchain-manifest-policy-v1` into the `policies`
...
check out our detailed technical guide on GitHub and don't hesitate to create a
Github issue if you have any questions, or join us on Telegram or Discord. Let's
welcome this exciting new chapter together. We're thrilled to be on this journey
with you!
