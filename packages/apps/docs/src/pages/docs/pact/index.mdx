...
layout: landing
icon: PactDeveloper
updatedOn: '2023-07-18T13:31:15.963Z'
---
...
Start with our [Beginner Tutorial Series](./beginner/welcome-to-pact) which
covers Pact’s fundamental concepts, followed by real smart contract projects you
can deploy to our Testnet. Also, the
