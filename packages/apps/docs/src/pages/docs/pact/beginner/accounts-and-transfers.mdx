...
[Pact Modules Tutorial](/learn-pact/beginner/modules)
...
[Pact Schemas and Tables Tutorial](/learn-pact/beginner/schemas-and-tables#define-schemas).
...
[Schemas and Tables Tutorial](/learn-pact/beginner/schemas-and-tables#table-built-in-functions)
as well as the
[Pact Language Basics Tutorial](/learn-pact/beginner/language-basics#built-in-functions).
