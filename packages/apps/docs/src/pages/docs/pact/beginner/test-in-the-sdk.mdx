...
- [Project: Loans](/learn-pact/beginner/loans) : You will be building a REPL
  file for the Loans project covered in a separate tutorial. This isn’t required
  but is a helpful way to better understand the smart contract used throughout
  this tutorial.
...
![3-online-editor-callouts](/assets/docs.png)
...
| function                                                      | purpose                                                             |
| ------------------------------------------------------------- | ------------------------------------------------------------------- |
| [create-a-loan](/learn-pact/beginner/loans/#52-create-a-loan) | Accepts parameters to add the appropriate information to each table |
| [assign-a-loan](/learn-pact/beginner/loans/#53-assign-a-loan) | Assigns a loan to an entity.                                        |
| [sell-a-loan](/learn-pact/beginner/loans/#54-sell-a-loan)     | Sell a loan and log details in the loan history table.              |
...
[Project: Loans tutorial](/learn-pact/beginner/loans/)
...
| function                                                                         | purpose                                      |
| -------------------------------------------------------------------------------- | -------------------------------------------- |
| [read-loan-inventory](/learn-pact/beginner/loans/#59-read-loan-inventory)        | Reads all loans in the loan inventory table. |
| [read-loans-with-status](/learn-pact/beginner/loans/#510-read-loans-with-status) | Reads all loans with a specific status.      |
...
![6-keysets-repl](/assets/docs/6-keysets-repl.png)
...
![7-errors](/assets/docs/7-errors.png)
