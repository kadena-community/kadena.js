...
You can create your own smart contract or [download it from the blockchain ](/kadena/client/contractbased-interaction-using-kadenaclient#downloading-contracts-from-the-blockchain)
using `pactjs`.
