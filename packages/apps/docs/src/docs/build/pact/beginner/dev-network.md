---
title: Set up a development network
description: Kadena makes blockchain work for everyone.
menu: Set up a development network
label: Set up a development network
order: 3
layout: full
...
## Chainweaver web-based editor

Chainweaver provides a combination of integrated account management and Pact editing features that you can use to develop smart contracts with Pact.

With Chainweaver, you can build and test contracts before deploying them to your private chain, the Kadena test network, or [Chainweb](/blogchain/2019/all-about-chainweb-101-and-faqs-2019-02-01).

The Chainweaver web-based REPL enables  you to write Pact code, explore smart contract modules and functions, manage keysets, deploy smart contracts, and update previously-deployed contracts.

To get started with Chainweaver:

1. Navigate to [chainweaver.kadena.network](https://chainweaver.kadena.network/).
