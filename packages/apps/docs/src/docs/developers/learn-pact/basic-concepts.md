...
This part of the documentation covers core concepts for programming using the Pact smart contract programming language and working with key features such as guards, capabilities, pacts, and module references. 
