...
const SvgReceiverIconActive = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#receiver-icon-active_svg__a)">
      <path
        fill="#fff"
    ...
    <defs>
      <clipPath id="receiver-icon-active_svg__a">
        <path fill="#fff" d="M0 0h40v40H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgReceiverIconActive;
