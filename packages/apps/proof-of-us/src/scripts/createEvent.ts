...
const startTime = Math.round(new Date(2024, 2, 8, 16, 28).getTime() / 1000);
...
const eventName = 'steven test11';
const eventType: TokenType = 'attendance';
const imageBase64Str =
  'data:image/png;base64,';
