...
const startTime = Math.round(new Date(2024, 3, 4, 17, 8).getTime() / 1000);
const endTime = Math.round(new Date(2025, 4, 3, 1).getTime() / 1000);
...
const imageBase64Str =
  'data:image/png;base64,';
