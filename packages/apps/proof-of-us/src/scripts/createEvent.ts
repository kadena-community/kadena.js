...
const startTime = Math.round(new Date(2024, 2, 8, 14, 33).getTime() / 1000);
const endTime = Math.round(new Date(2024, 2, 9, 1).getTime() / 1000);
...
const eventName = 'steven test2';
const eventType: TokenType = 'attendance';
const imageBase64Str =
  'data:image/png;base64,';
