...
export type GetTokensQuery = { __typename?: 'Query', nonFungibleAccount?: { __typename?: 'NonFungibleAccount', accountName: string, id: string, nonFungibles: Array<{ __typename?: 'Token', balance: number, id: string }> } | null };
