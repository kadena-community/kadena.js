...
import { useBlockInfo, useNodeInfo } from 'services/api';
import { NetworkContext } from 'services/app';
import { decodeBase64ToBlakeString, decodeBase64ToString } from 'utils';
  ...
  const headerData = [
    ...
    },
    {
      ...
      value: blockInfo?.blockHeader?.epochStart
        ? DateTime.fromMillis(blockInfo?.blockHeader?.epochStart / 1000).toISO()
        : '',
    },
    {
      id: 10,
