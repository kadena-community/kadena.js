...
import type { ICommandResult, LocalResponse } from '../interfaces/PactAPI';
...
//     cmd: commandStr1,
//     hash: cmdWithOneSignature1.hash,
//     sigs: [cmdWithOneSignature1.sig ? { sig: cmdWithOneSignature1.sig } : undefined,],
//   };
//
//   if (isSignedCommand(signedCommand1)) {
//     const commandResult1: LocalResponse = {
//       reqKey: 'uolsidh4DWN-D44FoElnosL8e5-cGCGn_0l2Nct5mq8',
//       txId: null,
//       result: {
