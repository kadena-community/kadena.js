...
exports.getLexerOutput = exports.getModuleAndMethods = exports.filterFlattenWrap = exports.wrap = exports.flattenRecursive = exports.lexer = void 0;
var moo = require("moo");
/**
 * @internal
 */
 ...
 * @internal
 */
var wrap = function (type) { return function (a) {
    return {
        type: type,
        value: a
    };
 ...
 * @internal
 */
var filterFlattenWrap = function (type) { return function (a) {
    ...
    while ((token = exports.lexer.next())) {
        ...
        switch (token.type) {
            ...
            case KW_ATOM:
                ...
                else if (state.stack.includes(KW_MODULE) &&
                    state.stack.includes(KW_DEFUN) &&
                    state.stack.includes(STACK_ARGS)) {
                    var line = token.line, col = token.col;
                ...
                break;
            case 'colon':
                if (state.stack.includes(KW_DEFUN) &&
                    !state.stack.includes(STACK_ARGS) &&
...
function lastThreeTokenTypedAtomMatch(tokens) {
    return tokens.map(function (t) { return t === null || t === void 0 ? void 0 : t.type; }).join() === TYPED_TOKEN_MATCH;
}
