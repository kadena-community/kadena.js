...
interface ITagStyledItemProps extends AriaTagProps<object> {
  state: ListState<object>;
}

export const TagStyledItem: FC<ITagStyledItemProps> = (props) => {
...
export interface ITagItemProps extends React.ComponentProps<typeof Item> {
  asChild?: boolean;
}
