...
describe('Select', () => {
  ...
  it(
    'renders the provided children options when is open',
    async () => {
      render(
  ...
  it(
    'invokes the onChange event handler when an option is selected',
    async () => {
  ...
  it(
    'disables the select element when disabled prop is true',
    () => {
      render(
