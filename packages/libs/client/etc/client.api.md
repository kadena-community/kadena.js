...
// @alpha
export function getContCommand(
  requestKey: string,
...
{
  constructor();
  addCap<T extends Array<PactValue> = Array<PactValue>>(
    capability: string,
    signer: string,
    ...args: T
  ): this;
...
// @alpha (undocumented)
export function signWithChainweaver<T extends IPactCommandSignable>(
  ...transactions: T[]
): Promise<T[]>;
