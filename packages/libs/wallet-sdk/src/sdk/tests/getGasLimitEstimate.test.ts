...
//   url: string,
//   responseData: {
//     result: { gasLimit: number; status: 'success' };
//   } | null,
//   responseType: 'json' | 'error' = 'json',
// ) {
//   server.use(
//     http.post(url, (req) => {
//       if (responseType === 'json' && responseData) {
...
//   const chainId = '1';
//   const host = `https://api.testnet.chainweb.com/chainweb/0.0/${networkId}/chain/${chainId}/pact/api/v1/local`;
...
//     setupServerResponse(host, {
//       result: { gasLimit, status: 'success' },
//     });
...
//     setupServerResponse(host, null, 'error');
