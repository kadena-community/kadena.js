...
export const GAS_PAYER = {
  ACCOUNT: env('GAS_PAYER_ACCOUNT', `k:${SENDER.PUBLIC_KEY}`),
  PUBLIC_KEY: env('GAS_PAYER_PUBLIC_KEY', SENDER.PUBLIC_KEY),
  SECRET_KEY: env('GAS_PAYER_SECRET_KEY', SENDER.SECRET_KEY),
};
...
export const AMOUNT_TO_TRANSFER_TO_FAUCET: string = env(
  'AMOUNT_TO_TRANSFER_TO_FAUCET',
  '1000',
);

export const TO_FUND_PUBLIC_KEY = env('TO_FUND_PUBLIC_KEY', SENDER.PUBLIC_KEY);
