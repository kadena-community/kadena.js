...
const inputs = {
  ...
  policies: ['marmalade-v2.guard-policy-v1','marmalade-v2.collection-policy-v1', 'marmalade-v2.non-fungible-policy-v1', 'marmalade-v2.royalty-policy-v1', 'marmalade-v2.non-updatable-uri-policy-v1'],
  creator: {
