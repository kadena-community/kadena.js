...
// export const deployMarmaladeNamespaces1 = async ({
//   sender = defaultAccount,
//   chainId = defaultChainId,
//   networkId = defaultNetworkId,
//   namespaceFilesPath,
...
//   clientConfig,
// }: IDeployMarmaladeNamespacesInput) => {
//   //  const transactionBodyGenerator  =

//   const sortFunction = (a: string, b: string) => {
//     const indexA = namespaceConfig.findIndex((config) =>
//       a.includes(config.file),
//     );
//     const indexB = namespaceConfig.findIndex((config) =>
//       b.includes(config.file),
//     );

//     // If a.file is not found in namespaceFiles, put it at the end
//     if (indexA === -1) return 1;
//     // If b.file is not found in namespaceFiles, put it at the beginning
...
//   const transactionBodyGenerator = (file: string) => {
//     let keysets;
//     const keys = sender.publicKeys || [];
//     const pred = 'keys-all';
...
//     /* We need to define the keysets for each namespace since
//           they are different */
//     if (file === 'ns-contract-admin.pact') {
//       keysets = [
//         {
//           name: `${namespace}.marmalade-contract-admin`,
//           keys,
...
//         },
//       ];
//     } else if (file === 'fungible-util.pact') {
//       keysets = [
//         {
//           name: 'util-ns-admin',
//           keys,
