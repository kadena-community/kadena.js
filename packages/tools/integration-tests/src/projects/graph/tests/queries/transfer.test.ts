...
describe('Transfers', () => {
  ...
  test('Query: getTransfers by AccountName', async () => {
        ...
        edges: [
          {
            ...
            node: {
              ...
              id: 'VHJhbnNmZXI6WyJ5VGgyZ2ltSktyTVdEZ1JyZzhpRHBmRTJVRVItV09heWRqa2ZnRklXeFdVIiwiMCIsIjAiLCJNMWdhYmFrcWtFaV8xTjhkUkt0NHo1bEV2MWt1Q19ueExUbnlEQ3VaSUswIiwidk1nd0JuZFNSS1M1ZEc5QUlwVVJQZnNoZ0FxX3RpSUwwUnNaa0tTYUdDbyJd',
              transaction: {
                badResult: null,
                ...
                signers: [
                  {
                    ...
                    scheme: 'ED25519',
                    signature:
                      '7d67f976f835b262d69b501e78e55eba18da2f3856bd70803dd475c7ed0e8eae8191620979ad7e024813d0b98d660cceea34256f80b446e3466b0efd7e1dcc0f',
