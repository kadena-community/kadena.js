...
export const loadJSON = async (filePath) => JSON.parse(await fs.readFile(filePath, 'utf-8'));
export const loadJSONC = async (filePath) => JSONC.parse(await fs.readFile(filePath, 'utf-8'));
export const loadContents = async (filePath) => await fs.readFile(filePath, 'utf-8');
