...
export function retrieveCommand(program, version) {
    program
        .command('retrieve')
        .description('Retrieve contract from a chainweb-api in a /local call (see also: https://github.com/kadena-io/chainweb-node#configuring-running-and-monitoring-the-health-of-a-chainweb-node).')
        ...
        .addOption(new Option('-c, --chain <number>', 'Chain to retrieve from (default 1)')
